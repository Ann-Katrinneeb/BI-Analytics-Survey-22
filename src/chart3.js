...
export function initProdKPI() {
  ...
  var h = 950 - margin.top - margin.bottom;
  ...
  svg3.append("line")
    ...
    .attr("x2", -xLine)
    .attr("y2", LineGroupBegin + 11 + (4 * SpaceLine))
    .attr("stroke", "white")
    .attr("stroke-width", "1");
  ...
  for (count = 0; count < 5; count++) {
    ...
    svg3.append("line")
      .attr("class", "head")
      .attr("x1", -xLine)
      .attr("y1", LineGroupBegin + 11 + (SpaceLine * count))
      .attr("x2", -xLine2)
      .attr("y2", LineGroupBegin + 11 + (SpaceLine * count))
      .attr("stroke", "white")
      .attr("stroke-width", "1");
  }
